...
namespace Adopters.Data.Migrations.Seeding
{
    ...
    public static class SeedNotification
    {
        ...
        public static void Seed(AdoptersContext context)
        {
            ...
            list.Add(new Notification() { Id = Convert.ToInt32(NotificationType.NewCommentOnReport), Name = "Comentario en contenido creado", Active = true, IsEmail = true, IsSystem = true, SystemText = "%%TriggerUser.Name%% ha comentado <b>%%Report.Name%%</b>", Tags = "[{ \"key\":\"%%NotifiedUser.Name%%\",\"value\":\"Nombre del usuario\" },{ \"key\":\"%%NotifiedUser.Email%%\",\"value\":\"Correo del usuario notificado\" },{ \"key\":\"%%TriggerUser.Name%%\",\"value\":\"Nombre del usuario que realiza acción\" },{ \"key\":\"%%TriggerUser.Email%%\",\"value\":\"Correo del usuario que realiza acción\" },{\"key\":\"%%Url%%\" , \"value\": \"Link principal\"},{\"key\":\"%%Report.Name%%\", \"value\":\"Nombre del contenido\"},{\"key\":\"%%Report.Url%%\", \"value\":\"Link del contenido\"}]", EmailSubject = "%%TriggerUser.Name%% ha comentado %%Report.Name%%", EmailHtml = "<h2 style=\"color: #304a6f;text-align: center;font-size: 22px;\"><b>Han comentado %%Report.Name%%</b></h2> <p style=\"text-align: left;\"><br></p> <p style=\"text-align: left;\">Hola %%NotifiedUser.Name%%, mira que han dicho de %%Report.Name%% aquí.</p> <p></p> <p><a href=\"%%Report.Url%%\" style=\"color: #FFF; background: #3C75C2; font-size: 20px; text-decoration: none; margin: 10px auto; display: block; min-width: 140px; text-align: center; border-radius: 6px; padding: 10px 0;\">Ver comentario</a></p> <p>Muchas gracias por apoyar a las huellitas sin hogar.<br></p>" });
            list.Add(new Notification() { Id = Convert.ToInt32(NotificationType.NewSubcommentOnMyComment), Name = "Subcomentario en mi comentario", Active = true, IsEmail = true, IsSystem = true, SystemText = "Han respondido tu comentario sobre %%Report.Name%%", Tags = "[{ \"key\":\"%%NotifiedUser.Name%%\",\"value\":\"Nombre del usuario\" },{ \"key\":\"%%NotifiedUser.Email%%\",\"value\":\"Correo del usuario notificado\" },{ \"key\":\"%%TriggerUser.Name%%\",\"value\":\"Nombre del usuario que realiza acción\" },{ \"key\":\"%%TriggerUser.Email%%\",\"value\":\"Correo del usuario que realiza acción\" },{\"key\":\"%%Url%%\" , \"value\": \"Link principal\"},{\"key\":\"%%Report.Name%%\", \"value\":\"Nombre del contenido\"},{\"key\":\"%%Report.Url%%\", \"value\":\"Link del contenido\"}]", EmailSubject = "Han respondido tu comentario sobre %%Report.Name%%", EmailHtml = "<h2 style=\"color: #304a6f;text-align: center;font-size: 22px;\"><b>Han respondido tu comentario en &nbsp;%%Report.Name%%</b></h2> <p style=\"text-align: left;\"><br></p> <p style=\"text-align: left;\">Hola %%NotifiedUser.Name%%, mira que han dicho de %%Report.Name%% aquí.</p> <p></p> <p><a href=\"%%Report.Url%%\" style=\"color: #FFF; background: #3C75C2; font-size: 20px; text-decoration: none; margin: 10px auto; display: block; min-width: 140px; text-align: center; border-radius: 6px; padding: 10px 0;\">Ver comentario</a></p> <p>Muchas gracias por apoyar a las huellitas sin hogar.<br></p>" });
            list.Add(new Notification() { Id = Convert.ToInt32(NotificationType.NewSubcommentOnSomeoneElseComment), Name = "Subcomentario en el comentario de otro", Active = true, IsEmail = true, IsSystem = true, SystemText = "Han comentado algo que comentaste", Tags = "[{ \"key\":\"%%NotifiedUser.Name%%\",\"value\":\"Nombre del usuario\" },{ \"key\":\"%%NotifiedUser.Email%%\",\"value\":\"Correo del usuario notificado\" },{ \"key\":\"%%TriggerUser.Name%%\",\"value\":\"Nombre del usuario que realiza acción\" },{ \"key\":\"%%TriggerUser.Email%%\",\"value\":\"Correo del usuario que realiza acción\" },{\"key\":\"%%Url%%\" , \"value\": \"Link principal\"},{\"key\":\"%%Report.Name%%\", \"value\":\"Nombre del contenido\"},{\"key\":\"%%Report.Url%%\", \"value\":\"Link del contenido\"}]", EmailSubject = "Han comentado algo que comentaste", EmailHtml = "<h2 style=\"color: #304a6f;text-align: center;font-size: 22px;\"><b>Han respondido en un comentario</b></h2> <p style=\"text-align: left;\"><br></p> <p style=\"text-align: left;\">Hola %%NotifiedUser.Name%%, mira que han dicho de %%Report.Name%% aquí.</p> <p></p> <p><a href=\"%%Report.Url%%\" style=\"color: #FFF; background: #3C75C2; font-size: 20px; text-decoration: none; margin: 10px auto; display: block; min-width: 140px; text-align: center; border-radius: 6px; padding: 10px 0;\">Ver comentario</a></p> <p>Muchas gracias por apoyar a las huellitas sin hogar.<br></p>" });
